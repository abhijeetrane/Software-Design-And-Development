...
import java.util.*;
import java.lang.*;
/** This class implement the MRU Spid Organize by  Intensity algorithm.

@author Tahiti.
*/

public class MRUSpidOintensity implements UpdateMethod{
	 ...
	 *
	 */
	public MRUSpidOintensity(Entities entities){

...
import java.util.*;
import java.lang.*;
/** This class implement the MRU Clid Intensity algorithm.

@author Tahiti.
*/
public class MRUClidIntensity implements UpdateMethod{
	 ...
	 *
	 */
	public MRUClidIntensity(Entities entities){

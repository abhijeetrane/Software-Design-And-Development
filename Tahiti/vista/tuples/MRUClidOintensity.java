...
import java.util.*;
import java.lang.*;
/** This class implement the MRU Clid Organize by  Intensity algorithm.

@author Tahiti.
*/

public class MRUClidOintensity implements UpdateMethod{
	 ...
	 *
	 */
	public MRUClidOintensity(Entities entities){

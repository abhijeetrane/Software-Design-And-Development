...
import java.util.*;
import java.lang.*;
/** This class implement the MRU Spid Intensity algorithm.

@author Tahiti.
*/

public class MRUSpidIntensity implements UpdateMethod{
	 ...
	 *
	 */
	public MRUSpidIntensity(Entities entities){
   this.entities=entities;
    ...
    public Vector getLocators(){
        ...
        for(int nr=0;nr<sizeEntities;nr++){
